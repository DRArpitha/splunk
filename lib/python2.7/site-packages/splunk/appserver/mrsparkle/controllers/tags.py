...
class TagsController(BaseController):
    ...
    @route('/:app/:fields=fields/:field_name/:field_value')
	...
	postargs['value'] = field_value #should be field_value
        ...
        if error is None and serverResponse.status not in [200, 201]:
            cherrypy.response.status = 400
            error = ERROR_FAIL_UPDATE
        return self.get_field_tags(app, fields, field_name, field_value, error, **args)
    ...
    def get_field_tags(self, app, fields, field_name, field_value,  error=None, **args):
        error  = None
    ...
    def get_action(self, app, field_name, field_value):
        ...
        '''
        return self.make_url(['/tags', app, 'fields', field_name, field_value])

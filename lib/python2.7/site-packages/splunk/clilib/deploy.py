...
ARG_MCASTIP,     XML_MCASTIP     =  "multicast-ip",    "interfaceIP"
ARG_DEPSERVURI,  XML_DEPSERVURI  =  "poll-uri",        "deploymentServerUri"
ARG_MCASTFREQ,   XML_MCASTFREQ   =  "multicast-freq",  "frequency"
ARG_MCASTURI,    XML_MCASTURI    =  "multicast-uri",   "multicastUri"
ARG_POLLFREQ,    XML_POLLFREQ    =  "poll-freq",       "pollingFrequency"
ARG_SENDMCAST,   XML_SENDMCAST   =  "send-multicast",  "sendMulticast"

optionMapClient = {
  ARG_MCASTIP     : XML_MCASTIP,
  ARG_MCASTURI    : XML_MCASTURI,
...
#
# entry points for setting/getting the multicast or poll uri before startup
#

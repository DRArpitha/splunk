...
class ModuleController(BaseController):
    ...
    def renderModule(self, host_app, module, action, **args):
        ...
        try:
            ...
            pageContent = '<p class="moduleException">%s</p>' % su.escape(errorString)
    ...
    def renderJobStatusMessage(self, **kwargs):
        ...
        try:
            ...
            logger.exception(e)
            pageContent = '<p class="moduleException">%s</p>' % e
...
class ModuleHandler(object):
    ...
    def render_json(self, response_data, set_mime=None):

    ...
    */
    ...
    ApplicationController.prototype = {
        ...
        updateControls: function(panelType) {
            ...
            this.controls.legendTruncation.setValue(this.panel.fields.options['charting.legend.labelStyle.overflowMode'] || 'ellipsisEnd');
            ...
            this.controls.gaugeRangeSelectMode.addValueChangeListener(function(value) {
                if(value === 'automatic') {
                    ...
                    var value = that.controls.gaugeColorPicker.getValue();
            ...
            this.controls.unitScale.setValue(this.panel.fields.options['charting.axisY.scale'] || this.panel.fields.options['charting.secondaryAxis.scale'] || 'linear');

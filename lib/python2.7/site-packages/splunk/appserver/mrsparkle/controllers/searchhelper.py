...
class SearchHelperController(BaseController):
    ...
    def index(self, search="", insertpos=None, minimize=False, namespace='search', snippet=False, earliest_time=None, latest_time=None,
              count=50, max_time=1, servers=None, useTypeahead=False, showCommandHelp=True, showCommandHistory=True, showFieldInfo=True, **kwargs):
        ...
        if minimize:
            template = 'searchhelper/runningsearch.html'
        elif easter != None:
            template = easter[0]

...
<deployment name="somename">
    ...
    <!-- 
    # The endpoint from which all apps can be downloaded.  This value can be overriden by serviceClass or ap declarations below.
    ...
    <!--
    # The location on the deploymentClient where all applications will be installed. This value can be overriden by serviceClass or 
